	...
	public class RippleModel
	{
		...
		public RippleModel (CGSize screenSize, int meshFactor, int touchRadius, CGSize textureSize)
		{
			...
			if ((float)screenSize.Height/screenSize.Width < (float)textureSize.Width/textureSize.Height){
				texCoordFactorS = (float)(textureSize.Height*screenSize.Height)/(float)(screenSize.Width*textureSize.Width);
				...
				texCoordFactorT = (float)(screenSize.Width*textureSize.Width)/(float)(textureSize.Height*screenSize.Height);
