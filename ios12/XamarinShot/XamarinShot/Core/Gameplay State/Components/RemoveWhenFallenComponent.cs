...
namespace XamarinShot.Models.GameplayState
{
    ...
    {
        private readonly SCNVector3 MinBounds = new SCNVector3(-80f, -10f, -80f); // -10.0 represents 1.0 meter high table
        private readonly SCNVector3 MaxBounds = new SCNVector3(80f, 1000f, 80f);
