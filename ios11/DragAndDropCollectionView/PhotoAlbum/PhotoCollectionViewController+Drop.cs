					...
					var progress = dragItem.ItemProvider.LoadObject<UIImage> (
								(droppedImage, err) => {
									DispatchQueue.MainQueue.DispatchAsync (() => {
										...
										if (image != null) {   //The image loaded successfully, commit the insertion to exchange the placeholder for the final cell.
											placeholderContext?.CommitInsertion ((insertionIndexPath) => {   // Update the photo library backing store to insert the new photo, using the insertionIndexPath passed into the closure.
										...
										} else {   // The data transfer for this item was canceled or failed, delete the placeholder.
