...
public partial class VisionObjectRecognitionViewController : ViewController
{
        ...
        {
                // Setup Vision parts
                var visionModel = VNCoreMLModel.FromMLModel (new ObjectDetector ().model!, out NSError error);
                ...
                var objectRecognition = new VNCoreMLRequest (visionModel!, (VNRequest request, NSError requestError) =>
                 {
                         ...
                         {
                                 Console.WriteLine ($"{requestError.LocalizedDescription}");
                         }
                 });
        ...
        protected override void SetupAVCapture ()
        {
                base.SetupAVCapture ();
        ...
        void UpdateLayerGeometry ()
        {
                ...
                var scale = NMath.Max (xScale, yScale);
