...
public partial class ViewController : UIViewController
{
        ...
        {
                var redEnabled = NSUserDefaults.StandardUserDefaults.BoolForKey (ManageNotificationsViewController.RedNotificationsEnabledKey);
                if (redEnabled)
                {
        ...
        {
                var greenEnabled = NSUserDefaults.StandardUserDefaults.BoolForKey (ManageNotificationsViewController.GreenNotificationsEnabledKey);
                if (greenEnabled)
                {
                        var content = new UNMutableNotificationContent ()
                        {
