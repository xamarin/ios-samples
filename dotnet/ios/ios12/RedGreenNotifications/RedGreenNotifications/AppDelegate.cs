...
public class AppDelegate : UIApplicationDelegate, IUNUserNotificationCenterDelegate
{
        ...
        public override bool FinishedLaunching (UIApplication application, NSDictionary launchOptions)
        {
                ...
                var initializedNotificationSettings = NSUserDefaults.StandardUserDefaults.BoolForKey (InitializedNotificationSettingsKey);
        ...
        public void OpenSettings (UNUserNotificationCenter center, UNNotification notification)
        {
                ...
                {
                        if (navigationController.VisibleViewController is ViewController currentViewController)
                        {
