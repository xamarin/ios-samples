...
public static class SCNNodeExtensions
{
        ...
        static Dictionary<SCNNode, GameObject> map = new Dictionary<SCNNode, GameObject> ();
        ...
        public static void FixNormalMaps (this SCNNode node)
        {
                if (node.Geometry is not null)
                {
                        ...
                        if (node.Geometry.LevelsOfDetail is not null)
                        {
        ...
        public static void CopyGeometryForPaintColors (this SCNNode node)
        {
                ...
                if (node.Geometry is not null && !string.IsNullOrEmpty (node.Name))
                {
        ...
        static SCNNode? FindNodeWithPhysicsBodyHelper (SCNNode node)
        {
                SCNNode? result = null;
                if (node.PhysicsBody is not null)
                {
                        ...
                        foreach (var child in node.ChildNodes)
                        {
                                if (ShouldContinueSpecialNodeSearch (child))
                                {
                                        ...
                                        if (childWithPhysicsBody is not null)
                                        {
        ...
        static SCNNode? FindNodeWithGeometryHelper (SCNNode node)
        {
                SCNNode? result = null;
                if (node.Geometry is not null)
                {
                        ...
                        foreach (var child in node.ChildNodes)
                        {
                                if (ShouldContinueSpecialNodeSearch (child))
                                {
                                        ...
                                        if (childWithGeosBody is not null)
                                        {
        ...
        static bool ShouldContinueSpecialNodeSearch (SCNNode node)
        {
                bool result = true;
        ...
        public static void SetPaintColors (this SCNNode node)
        {
                ...
                if (geometry is not null)
                {
                        ...
                        if (lods is not null)
                        {
                                ...
                                {
                                        if (lod?.Geometry is not null && lod.Geometry.HasUniform (PaintMaskColorKey))
                                        {
        ...
        public static void FixLevelsOfDetail (this SCNNode node, float screenSpaceRadius, bool showLOD)
        {
                ...
                if (lods is not null && node?.Geometry is not null)
                {
                        var lodsNew = new List<SCNLevelOfDetail> ();
                        foreach (var lod in lods)
                        {
        ...
        public static void SetupPaintColorMask (this SCNGeometry geometry, string name)
        {
                ...
                if (geometry.ValueForKey (new NSString (PaintMaskColorKey)) is null)
                {
