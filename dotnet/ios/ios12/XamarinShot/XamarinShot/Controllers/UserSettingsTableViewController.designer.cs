...
namespace XamarinShot
{
    ...
    partial class UserSettingsTableViewController
    {
        ...
        void ReleaseDesignerOutlets ()
        {
            ...
            if (effectsVolume is not null) {
                effectsVolume.Dispose ();
                effectsVolume = null;
            }

            if (musicVolume is not null) {
                musicVolume.Dispose ();
                musicVolume = null;
            }

            if (playerNameTextField is not null) {
                playerNameTextField.Dispose ();
                playerNameTextField = null;
            }

            if (selectedLevelLabel is not null) {
                selectedLevelLabel.Dispose ();
                selectedLevelLabel = null;
            }

            if (spectatorSwitch is not null) {
